    ...
    if (empty($comments)) {
        ...
        foreach ($comments as $comment) {
            ...
            if (isset($_SESSION['user'])) {
                echo ' <a href="index.php?action=deleteComment&id=' . $comment->getId() . '&idArticle=' . $article->getId() . '"
                          class="delete-link" ' . Utils::askConfirmation("Supprimer ce commentaire ?") . '>Supprimer</a>';
            }
            // -------------------------------------
